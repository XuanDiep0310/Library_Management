...
linkedlist<User>* readfileuser()
{
    ...
    ifstream ip("C:\\Users\\XuanDiep\\Documents\\LibManagement\\x64\\Debug\\Sinhvien.txt");
    ifstream ip4("C:\\Users\\XuanDiep\\Documents\\LibManagement\\x64\\Debug\\Borrow.txt");
    ifstream ip5("C:\\Users\\XuanDiep\\Documents\\LibManagement\\x64\\Debug\\Request.txt");
    if (!ip)
    {
...
linkedlist<Book>* docfilebook()
{
    ...
    Book book;
    ifstream ip2("C:\\Users\\XuanDiep\\Documents\\LibManagement\\x64\\Debug\\Book.txt");
    if (!ip2)
    {
...
list readfiledata()
{
    ifstream ip3("C:\\Users\\XuanDiep\\Documents\\LibManagement\\x64\\Debug\\data.txt");
    list l;
    if (!ip3)
    {
